...
import { IconBriefcase, IconInfinity } from "@tabler/icons-react"
...
import type { ExperiencePosition } from "@/types/portfolio/experiences"
        ...
        <div className="flex items-center gap-2 pl-9 text-sm text-muted-foreground">
          ...
          <dl>
            ...
            <dd className="flex items-center gap-0.5">
              ...
              {isOngoing ? (
                <>
                  <IconInfinity className="size-4.5 translate-y-[0.5px]" />
